...
namespace Solution.Locator.Web.Host.Startup
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.SwaggerDoc("v1", new Info { Title = "Locator API", Version = "v1" });
            ...
            return services.AddAbp<LocatorWebHostModule>(
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwaggerUI(options =>
            {
                ...
                options.SwaggerEndpoint("/swagger/v1/swagger.json", "Locator API V1");
            }); // URL: /swagger
        }
