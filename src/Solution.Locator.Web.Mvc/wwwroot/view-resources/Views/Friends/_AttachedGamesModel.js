(function ($) {
    ...
    var _friendService = abp.services.app.attached;
    var _$modal = $('#AttachedGamesModal');
    var _$form = $('form[name=AttachedGameEditForm]');
    ...
    function save() {
        ...
        _friendService.attached(friend).done(function () {
            _$modal.modal('hide');
